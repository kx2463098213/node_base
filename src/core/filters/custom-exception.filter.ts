import {
  ArgumentsHost, Catch, ExceptionFilter, HttpException, HttpStatus, UnauthorizedException,
} from '@nestjs/common';
...
export class CustomExceptionFilter implements ExceptionFilter {
  ...
  constructor(
    private readonly i18n: MyI18nService,
  ) { }
  ...
  private translate(code: number, param?: Record<string, any>): string {
    if (code && code !== 500) {
      return this.i18n.getMessage(code.toString(), param);
    }
    return '';
  }
}